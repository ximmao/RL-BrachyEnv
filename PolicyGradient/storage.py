...
class MCRolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_feature_shape, action_shape):
        assert obs_feature_shape == action_shape, "feature space and action space have to be same size equal to num of dwell points"
        self.obs = torch.zeros(num_steps + 1, num_processes, obs_feature_shape)
